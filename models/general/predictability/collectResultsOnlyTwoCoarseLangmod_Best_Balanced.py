...
BASE_DIR = "manual_output_funchead_langmod_coarse_best_balanced"
...
inHeader = ["FileName", "ModelName", "Counter", 'AverageLoss_LM', "DH_Weight", "CoarseDependency", "DistanceWeight", "ObjectiveName"]

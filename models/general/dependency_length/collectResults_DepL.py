...
BASE_DIR = "manual_output_funchead_coarse_depl_balanced"
...
inHeader = ["FileName", "Counter", "DH_Weight", "Dependency", "DistanceWeight"]
outHeader = ["Language"] + inHeader


outpath = outPath+"auto-summary-lstm.tsv"

...
BASE_DIR = "manual_output_funchead_two_coarse_lambda09_best_balanced"
...
inHeader = ["FileName", "Counter", 'AverageLoss_LM', 'AverageLAS', 'AverageLoss_Parser', 'AverageUAS',  "DH_Weight", "CoarseDependency", "DistanceWeight"] 

...
def orderChildrenRelative(sentence, remainingChildren, reverseSoftmax):
       childrenLinearized = remainingChildren[:]
...
def orderSentence(sentence, dhLogits, printThings):
   ...
   if model != "REAL_REAL":
      for line in sentence:
         shuffle(line["children"])
         separation = randint(0, len(line["children"]))
         line["children_DH"] = line["children"][:separation]
         line["children_HD"] = line["children"][separation:]
    #     if "children_DH" in line:

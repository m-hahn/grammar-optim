...
rnn = nn.LSTM(200, rnn_dim, lstm_layers, bidirectional=True, batch_first=True).cuda() # word_embedding_size + (2*
...
components = [ rnn, headRep, depRep, headMLPOut, dependentMLPOut, labelMLP, labelDecoder] 
...
while True:
  ...
  if True:
         ...
         with open("../../../../raw-results/parsing-withoutPOS/performance-"+language+"_"+FILE_NAME+"_model_"+str(myID)+"_"+model+".txt", "w") as outFile:

...
FILE_NAME = "sososo_coarse_parser_lexicalized_plane"
...
while True:
  ...
  if True:
         ...
         with open("../../../../raw-results/parsing-lexicalized/performance-"+language+"_"+FILE_NAME+"_model_"+str(myID)+"_"+model+".txt", "w") as outFile:

...
import os
parsingDone = [x.split("_")[-1][:-4] for x in os.listdir("../../../../raw-results/parsing_coarse_lexicalized_plane/") if "estimateParseability" in x]
print(parsingDone)

script = "estimateParseability_Lexicalized.py"
...
while failures < 300:
  existingFiles = os.listdir("../../../../raw-results/parsing-lexicalized/")

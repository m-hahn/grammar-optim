...
FILE_NAME = "sososo_coarse_parser_plane2"
...
assert "RANDOM" not in model, "I think this shouldn't happen, as random grammars are created when estimating predictability"
...
while True:
  ...
  if True:
         ...
         with open("../../../../raw-results/parsing-upos-pureUD/performance-"+language+"_"+FILE_NAME+"_model_"+str(myID)+"_"+model+".txt", "w") as outFile:

...
scripts = ["estimatePredictability_WithoutPOS_ByBranchingEntropy.py"]
...
while failures < 200:
  existingFiles = os.listdir("../../../../raw-results//language_modeling_coarse_plane_fixed_withoutPOS_nondeterministic")

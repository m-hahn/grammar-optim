...
while True:
  ...
  if True: 
          ...
          with open(save_path+"/language_modeling_coarse_plane_fixed_withoutPOS_nondeterministic/"+language+"_"+FILENAME+"_languageModel_performance_"+model+"_"+str(myID)+".tsv", "w") as outFile:

...
ggsave(plot, file="result_NPBranching0_0_DLM.pdf")
...
ggsave(plot, file="result_NPBranching0_1_DLM.pdf")
...
ggsave(plot, file="result_NPBranching0.1.pdf")
...
ggsave(plot, file="result_NPBranching0_3_DLM.pdf")

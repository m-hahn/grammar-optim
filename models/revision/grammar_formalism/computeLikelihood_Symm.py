...
def orderChildrenRelative(sentence, remainingChildren, reverseSoftmax):
       ...
       while len(remainingChildren) > 0:
           ...
           selected = len(softmax)-1 if reverseSoftmax else 0
...
inpModels_path = "../../../raw-results/"+"/"+"manual_output_funchead_ground_coarse_final"+"/"
models = os.listdir(inpModels_path)
models = filter(lambda x:language+"_infer" in x, models)
if len(models) == 0:

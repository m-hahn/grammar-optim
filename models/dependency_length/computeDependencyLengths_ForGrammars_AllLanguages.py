...
for model in models[int(starting*len(models)):int(ending*len(models))]:
  ...
  subprocess.call(["/u/nlp/anaconda/ubuntu_16/envs/py27-mhahn/bin/python2.7", "computeDependencyLengths/computeDependencyLengths_ForGrammars.py", language, language, modelNumber, str(temperature), BASE_DIR])

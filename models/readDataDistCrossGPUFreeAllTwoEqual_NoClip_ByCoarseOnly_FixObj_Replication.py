...
def  doBackwardPass(loss_lm, baselineLoss_lm, policy_related_loss_lm, loss_parser, policy_related_loss_parser):
       if printHere:
         print "BACKWARD 1"
       policy_related_loss = (1.0/2) * policy_related_loss_lm + (1.0/2) * policy_related_loss_parser
...
#       torch.nn.utils.clip_grad_norm(parameters_parser(), args.clip_at_parser, norm_type=args.clip_norm_parser)


#       TODO what about clipping the parser's gradients?
...
#   newDevLoss_lm = devLoss_lm/devWords_lm
...
#             continue
          ...
          if len(devLosses_parser) == 5:
              print("Stopping after 5 epochs")
              quit()

...
print("/u/scr/mhahn/deps/plane-parse-random4.tsv")
with open("/u/scr/mhahn/deps/plane-parse-random4.tsv", "w") as outFile:
  ...
  for BASE_DIR in dirs:
   ...
   if BASE_DIR in ["REAL_REAL", "RANDOM"]:
      ...
      for i in range(len(models)):
         ...
         #    print(parts)
             if len(parts) < 4 or parts[-3] not in ["RANDOM", "RANDOM4"] or parts[-2] != "model":
                continue

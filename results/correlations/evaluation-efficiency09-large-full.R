...
sink("output/results-prevalence-two-09-large-full.tsv")
cat("")
sink()

cat(paste("dependency", "satisfiedFraction", "posteriorMean", "posteriorSD", "posteriorOpposite", sep="\t"), file="output/results-prevalence-two-09-large-full.tsv", append=TRUE, sep="\n")

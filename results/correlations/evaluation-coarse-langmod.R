...
data = read.csv("CS_SCR/deps/manual_output_funchead_langmod_coarse/auto-summary-lstm.tsv", sep="\t")# %>% rename(Quality=AverageLength)
...
dependencies = c("acl", "advcl", "advmod", "amod", "appos", "aux", "ccomp", "compound", "conj", "csubj", "dep", "det", "discourse", "dislocated", "expl", "fixed", "flat", "goeswith", "iobj", "lifted_case", "lifted_cc", "lifted_cop", "lifted_mark", "list", "nmod", "nsubj", "nummod", "obj", "obl", "orphan", "parataxis", "reparandum", "vocative", "xcomp")



sink("results-langmod.tsv")
cat("")
sink()

cat(paste("dependency", "satisfiedFraction", "posteriorMean", "posteriorSD", "posteriorOpposite", sep="\t"), file="results-langmod.tsv", append=TRUE, sep="\n")

...
ggsave(plot=plot, filename="figures/posterior-satisfied-universals-efficiency-large-full.pdf")


write.csv(u, file="~/CS_SCR/posteriors/posterior-10-efficiency-large-full.csv")

...
sink("output/results-prevalence-two-09-best.tsv")
cat("")
sink()

cat(paste("dependency", "satisfiedFraction", "posteriorMean", "posteriorSD", "posteriorOpposite", sep="\t"), file="output/results-prevalence-two-09-best.tsv", append=TRUE, sep="\n")

...
#  geom_tile(aes(colour="white")) +
  geom_point(aes(colour = Agree, size =1)) +
#  scale_fill_gradient(low="red", high="red", limits=c(0.0, 1), oob=squish) +
...
ggsave(file="figures/coverage-two-lambda09-large.pdf", plot=plot)

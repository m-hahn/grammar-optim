...
verb_patterner = ["adposition", "copula", "auxiliary", "noun", "noun", "complementizer", "verb", "want", "verb", "verb"]
noun_patterner = ["NP", "NP", "VP", "genitive", "relative clause", "S", "PP", "VP", "subject", "manner adverb"]

relevant = ["lifted_case", "lifted_cop", "aux", "nmod", "acl", "lifted_mark", "obl", "xcomp", "nsubj", "advmod"]
predicted = ["+", "+", "-", "+", "+", "+", "+", "+", "+", "+"]

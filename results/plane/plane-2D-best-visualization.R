...
summary(lmer(Surp ~ Type + (1|Language), data=dataS %>% filter(Type %in% c("manual_output_funchead_two_coarse_lambda09_best_balanced", "manual_output_funchead_langmod_coarse_best_balanced"))))
...
summary(lmer(Pars ~ Type + (1|Language), data=dataP %>% filter(Type %in% c("manual_output_funchead_two_coarse_final", "manual_output_funchead_two_coarse_lambda09_best_balanced"))))
...
data2Best = data %>% filter(Type == "manual_output_funchead_two_coarse_lambda09_best_balanced") %>% group_by(Language) %>% summarise(Two = min(Two))
...
data2 = data %>% filter(Type == "manual_output_funchead_two_coarse_lambda09_best_balanced")
...
D = data %>% filter(Type == "manual_output_funchead_two_coarse_lambda09_best_balanced") %>% select(Language, Type, Model, Pars, Surp)
...
subData = data %>% filter(Type %in% c("manual_output_funchead_two_coarse_parser_best_balanced", "manual_output_funchead_two_coarse_lambda09_best_balanced", "manual_output_funchead_langmod_coarse_best_balanced"))
...
plot = ggplot(data, aes(x=(Pars-MeanPars)/SDPars, y=(Surp-MeanSurp)/SDSurp, color=Type, group=Type)) +geom_point() + geom_point(data=summarizedData, aes(x=Pars, y=Surp, size=8)) + geom_path(data=summarizedData %>% filter(Type %in% c("manual_output_funchead_two_coarse_parser_best_balanced", "manual_output_funchead_two_coarse_lambda09_best_balanced", "manual_output_funchead_langmod_coarse_best_balanced")), aes(x=Pars, y=Surp, size=5, group=1))


plot = ggplot(data, aes(x=(Pars-MeanPars)/SDPars, y=(Surp-MeanSurp)/SDSurp, color=Type, group=Type, alpha=0.9)) +geom_point() + geom_point(data=summarizedData, aes(x=Pars, y=Surp, size=8, alpha=1.0)) + geom_path(data=summarizedData %>% filter(Type %in% c("manual_output_funchead_two_coarse_parser_best_balanced", "manual_output_funchead_two_coarse_lambda09_best_balanced", "manual_output_funchead_langmod_coarse_best_balanced")), aes(x=Pars, y=Surp, size=5, group=1, alpha=1.0)) + theme_bw() + geom_point(data=data %>% filter(grepl("ground", Type)), aes(x=(Pars-MeanPars)/SDPars, y=(Surp-MeanSurp)/SDSurp, color=Type, group=Type, alpha=1.0))  +geom_text(data=data %>% filter(grepl("ground", Type)), aes(label=Language, alpha=1.0),hjust=0, vjust=0) + geom_density_2d(data=data %>% filter(grepl("RANDOM", Type)), aes(alpha=1.0))+ geom_point(data=data %>% filter(grepl("REAL", Type)), aes(x=(Pars-MeanPars)/SDPars, y=(Surp-MeanSurp)/SDSurp, color=Type, group=Type, alpha=1.0))  +geom_text(data=data %>% filter(grepl("REAL", Type)), aes(label=Language, alpha=1.0),hjust=0, vjust=0)
...
plot = ggplot(data, aes(x=(Pars-MeanParsRand)/SDParsRand, y=(Surp-MeanSurpRand)/SDSurpRand, color=Type, group=Type, alpha=0.9)) +geom_point() + geom_point(data=summarizedDataRand, aes(x=Pars, y=Surp, size=8, alpha=1.0)) + geom_path(data=summarizedDataRand %>% filter(Type %in% c("manual_output_funchead_two_coarse_parser_best_balanced", "manual_output_funchead_two_coarse_lambda09_best_balanced", "manual_output_funchead_langmod_coarse_best_balanced")), aes(x=Pars, y=Surp, size=5, group=1, alpha=1.0)) + theme_bw() + geom_point(data=data %>% filter(grepl("ground", Type)), aes(x=(Pars-MeanParsRand)/SDParsRand, y=(Surp-MeanSurpRand)/SDSurpRand, color=Type, group=Type, alpha=1.0))  + geom_density_2d(data=data %>% filter(grepl("RANDOM", Type)), aes(alpha=1.0))
...
plot = plot + geom_path(data=dataPlot %>% filter(TypeN %in% c("Parseability", "Efficiency", "Predictability")), aes(x=-ParsMean, y=-SurpMean, group=1), color="gray", size=3)

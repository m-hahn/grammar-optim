...
In Japanese, the verb stands at the end; object and adpositional phrase precede it.
What both languages have in common is that the object and the adpositional phrase stand on the same side of the verb.
It turns out that this is a deep and stable regularity:
Languages ordering the objects before (Japanese) or after (Arabic) the verb are approximately equally common around the world.
...
The example above documents that the position of the object (`letter') relative to the verb is \key{correlated} with the position of adpositional phrases (`to a friend') relative to the verb.
...
These universals are supported by languages on all five continents, and they are valid across

These cross-linguistic patterns call for an explanation, and the problem of explaining the word order correlations has inspired a long tradition of research.

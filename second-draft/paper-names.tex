...
TODO Shannon
We model the meaning that the speaker communicates as the basic predicate-argument structure.
...
The listener receives a string of words, and attempts to reconstruct the underlying syntactic relations.

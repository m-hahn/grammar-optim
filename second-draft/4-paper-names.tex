...
This has been justified based on the reasoning that long dependencies create high memory requirements for parsing and generation \cite{gibson1998linguistic,gibson2000dependency}.
...
Large-scale corpus evidence across languages shows that natural languages order words in such a way as to reduce this quantity, compared to most random orderings \cite{futrell2015largescale,liu2017dependency,temperley2018minimizing}.
However, the link to Greenberg's correlations has not been established this directly.
...
copula    &    NP         
	&  \multirow{2}{*}{\includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-lifted_cop.pdf}}
	&   \multirow{2}{*}{  \textbf{81}$^{***}$    }
	&    \multirow{2}{*}{\includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-lifted_cop.pdf}   }
	&   \multirow{2}{*}{  \textbf{76}$^{***}$ }   
...
complementizer    &    S        & \\
	\emph{that} & \emph{Mary has arrived} \\
verb    &    PP     &    \\
...
These are described in Table~\ref{table:corr-dryer}.
...
For each optimized grammar, we can check which correlations it satisfies.
...
We conducted, for each correlation, a mixed-effects logistic regression model predicting whether a grammar satisfies the correlation, with random effects for languages and language families.\footnote{We coded language families according to \url{universaldependencies.org}.}
...
It is also stipulative: There is no a priori reason why dependency length should be the crucial determining factor determining word order. There are other models of processing cost that make different predictions.
...
%adp. &
adposition    &    NP       
	&   \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-lifted_case.pdf}   
	&    \textbf{81}$^{***}$    
	&   \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-lifted_case.pdf}   
	&    \textbf{76}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-lifted_case.pdf}  \\
copula    &    NP       
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-lifted_cop.pdf}
	&    \textbf{81}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-lifted_cop.pdf}
	&    \textbf{79}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-lifted_cop.pdf}  \\
auxiliary    &    VP       
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-aux.pdf} 
	&    \textbf{74}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-aux.pdf} 
	&    55    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-aux.pdf}  \\
noun    &    genitive      
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-nmod.pdf} 
	&    \textbf{82}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-nmod.pdf} 
	&    \textbf{74}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-nmod.pdf}  \\
noun    &    relative clause       
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-acl.pdf} 
	&    \textbf{85}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-acl.pdf} 
	&    \textbf{77}$^{**}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-acl.pdf}  \\
complementizer    &    S        
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-lifted_mark.pdf} 
	&    \textbf{85}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-lifted_mark.pdf} 
	&    \textbf{80}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-lifted_mark.pdf}  \\
verb    &    PP     
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-obl.pdf} 
	&    \textbf{78}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-obl.pdf} 
	&    59    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-obl.pdf}  \\
want    &    VP      
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-ground-xcomp.pdf} 
	&    \textbf{90}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-langmod-xcomp.pdf} 
	&    \textbf{92}$^{***}$    
	&    \includegraphics[width=0.03\textwidth]{../results/correlations/figures/correlations/correlation-efficiency-xcomp.pdf} 
  \\
 \hline
    \multicolumn{6}{l}{\footnotesize{Significance levels: $^*$: $p < 0.05$, $^{**}$: $p < 0.01$, $^{***}$: $p < 0.001$}}
\end{tabular}

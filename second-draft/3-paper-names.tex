...
% ,lin2017critical
\dropcap{U}nderstanding and explaining the universal properties of human languages is one of the central goals of Linguistics \cite{zipf1949human,greenberg1963universals,chomsky1993lectures,...}.
...
\begin{figure} % need Efficiency and (maybe) MLE langs on here
	...
	\caption{Across 51 languages, efficiency optimization predicts Greenberg's correlations. For every one of the 51 languages, we show which universals are satisfied in the actual grammar (left), and in the grammar optimized for efficiency (right). Efficiency optimization replicates the universals at rates similar to the real grammars.}\label{fig:per-lang}
\end{figure}

...
% ,lin2017critical
\dropcap{U}nderstanding and explaining the universal properties of human languages is one of the central goals of Linguistics \cite{behaghel1909beziehungen,zipf1949human,greenberg1963universals,chomsky1993lectures,...}.
...
In this work we examine this question from a computational perspective, demonstrating a fully formalized and implemented framework in which certain syntactic universals can be explained through the computational optimization of grammars for communicative efficiency. % information-theoretic 

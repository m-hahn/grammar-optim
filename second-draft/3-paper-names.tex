...
\dropcap{F} \cite{behaghel1909beziehungen,zipf1949human,greenberg1963universals,lin2017critical} \cite{hawkins2007processing,bender2009linguistically,bender2013linguistic}
...
Should the speaker do it as
Mary saw John (like in English)
or as 
Mary John saw (like in Japanese)

Depending on the language, the listener decodes this.
...
X languages improve over the baselines in parsability, Y improve in predictability.
Z improve in overall efficiency.
Pareto frontier

...
# _final/
data = read.csv("CS_SCR/deps/manual_output_funchead_two_coarse_lambda09_best_balanced/auto-summary-lstm.tsv", sep="\t")# %>% rename(Quality=AverageLength)
...
sink("results-prevalence-two-09-best.tsv")
cat("")
sink()

cat(paste("dependency", "satisfiedFraction", "posteriorMean", "posteriorSD", "posteriorOpposite", sep="\t"), file="results-prevalence-two-09-best.tsv", append=TRUE, sep="\n")

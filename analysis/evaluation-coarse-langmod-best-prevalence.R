...
sink("results-prevalence-langmod-best.tsv")
cat("")
sink()

cat(paste("dependency", "satisfiedFraction", "posteriorMean", "posteriorSD", "posteriorOpposite", sep="\t"), file="results-prevalence-langmod-best.tsv", append=TRUE, sep="\n")

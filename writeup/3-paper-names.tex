...
\begin{table}[ht]
	\begin{center}
    \includegraphics[width=0.45\textwidth]{table1.pdf}
	\end{center}
...
See SI Appendix, Section S5.2 for the methodology used to extract the languages' actual grammars from datasets, and for validation against expert judgments.
...
See SI Appendix, Section S2.1 for discussion.

...
\begin{figure}
    \centering
    \includegraphics[scale=.4]{figures/pareto-plane-iso-best-balanced-legend.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=.2]{figures/posterior-satisfied-universals-efficiency.pdf}
     \includegraphics[scale=.2]{figures/posterior-satisfied-universals-langmod.pdf}
     \includegraphics[scale=.2]{figures/posterior-satisfied-universals-parseability.pdf}
    \includegraphics[scale=.2]{figures/posterior-satisfied-universals-depl.pdf}

...
We used the MCMC implementation provided by the \texttt{R} package \texttt{dirichletprocess}~\citep{ross2018dirichletprocess}, discarding the first 1,000 samples as warmup samples, and obtaining another 1,000 samples.
...
\end{equation}
This quantifies how many hypothetical grammars are more efficient than $r$ \emph{irrespective} of $\lambda$.

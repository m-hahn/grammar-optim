...
TODO also mention: As we estimate parseability and predictability using cross-entropies, our models constitute variational approximations to the true parseability and predictability values.
A similar approach has been applied to quantifying morphological complexity by \citet{cotterell2019complexity}.

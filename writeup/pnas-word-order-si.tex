...
We also collected, for each language, all auxiliaires, that is, all dependents of the \emph{aux} dependency, occurring at least 10 times, and compared their dominant orders.
In X languages, all extracted auxiliaries had the same dominant order.
In X languages, there were auxiliaires with divergent order. In Y cases, these were modal auxiliaries, or uninflected elements. In Z cases, these were tense-aspect auxiliaries.

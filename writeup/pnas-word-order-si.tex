...
\begin{figure}
    ...
    \includegraphics[scale=.25]{../results/correlations/coverage-langmod-best.pdf}
    \includegraphics[scale=.25]{../results/correlations/coverage-parse-best.pdf}
    \includegraphics[scale=.25]{../results/correlations/coverage-two-lambda09-best.pdf}
    
    
    \includegraphics[scale=.25]{../results/correlations/coverage-ground.pdf}
    \includegraphics[scale=.25]{../results/correlations/coverage-depl.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=.7]{../results/correlations/posterior_joint_with_ud.pdf}
